# deckstring-ios-debug-demo Specification

## Purpose
定义 `DeckStringDecoderKMP` source repo 内的 iOS Kotlin/Native 断点调试 demo，明确其路径、Xcode/Gradle Debug framework 集成、Swift-facing API 调试入口，以及需要记录的本机构建和 LLDB 验证结果。
